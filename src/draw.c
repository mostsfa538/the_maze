...
/**
 * performDDA - Performs the DDA algorithm to calculate the distance to the wall.
                                ...
                                Player *player)
{
    ...
    double wallHeight = SCREEN_HEIGHT / perpWallDist;
    ...
    for (int y = drawStart; y < drawEnd; y++)
    {
        ...
        int texY = ((d * TEX_HEIGHT) / wallHeight) / 256;
        color color = instance->textures[texNum][TEX_HEIGHT * texY + texX];
